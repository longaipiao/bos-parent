        ...
        <div class="loginForm">
            <form id="loginform" name="loginform" method="post" class="niceform"
                ...
                <div class="loginFormIpt loginFormIptWiotTh"
                    ...
                    <span style="color: #92a4bf;">验证码：</span>
                    <div id="codeInputLine" class="loginFormIpt showPlaceholder"
                         style="margin-left:55px;margin-top:-40px;width:50px;">
                ...
                <div>
						...
						<span id="loginform:loginBtn" class="btn btn-login"
                              style="margin-top:10px;">登录</span>
                        </a>
                    </div>
                    <div>
                        <a onclick="window.location.href='${pageContext.request.contextPath}/regist.jsp'"
                           name="loginform:j_id19"><span class="btn btn-login" style="margin-top:10px;">注册</span>
                        </a>
                    </div>
                </div>
                <div align="center">
